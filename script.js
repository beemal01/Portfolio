...
function displayProjects(repos) {
    ...
    const featuredProjects = {
        'ai-humanizer-tool': {
            description: 'An AI-powered tool that humanizes text content, making it more natural and engaging for readers.',
            icon: 'fas fa-robot',
            tech: ['Python', 'TensorFlow', 'Natural Language Processing', 'Machine Learning', 'Flask']
        },
        'weather-app': {
...
function initDownloadCV() {
    ...
    downloadCvBtn.addEventListener('click', (e) => {
        ...
        // Create a temporary notification for CV download
        ...
        // window.open('path/to/bimal-kandel-cv.pdf', '_blank');
    });
}
